dataset_info = dict(
    ...
    skeleton_info={
        ...
        # 17: dict(link=('L_Hip', 'L_Shoulder'), id=17, color=[6, 156, 250]),
        # 18: dict(link=('R_Hip', 'R_Shoulder'), id=18, color=[6, 156, 250]),

        # 19: dict(link=('L_Hip', 'Neck'), id=19, color=[6, 156, 250]),
        # 20: dict(link=('R_Hip', 'Neck'), id=20, color=[6, 156, 250]),
        # 21: dict(link=('L_Shoulder', 'Root of tail'), id=21, color=[6, 156, 250]),
        # 22: dict(link=('R_Shoulder', 'Root of tail'), id=22, color=[6, 156, 250]),

        # 23: dict(link=('L_Eye', 'Neck'), id=23, color=[6, 156, 250]),
        # 24: dict(link=('R_Eye', 'Neck'), id=24, color=[6, 156, 250]),
    },
    joint_weights=[
